...
public class MyBatisGeneratorUtil {
    ...
    public static void main(String[] args) {
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/collect", "root", "12345678")
                //2、全局配置
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("user", "task", "code", "report", "work"); // 设置需要生成的数据表名
